...
Technologies Used: Python 3, Pandas and NumPy (Data manipulation & matrix algebra), Statsmodels (OLS Econometric regressions), Matplotlib & Seaborn (Data visualization), yfinance & pandas-datareader (API data pipelines)
Methodologies Demonstrated: Parametric & Historical Value at Risk (VaR), Covariance and Portfolio Variance, Stress Testing (Historical Simulation), Tracking Error (Active Risk), Fama-French 3 Factor Modeling
